...
**Downloaded**: December 15, 2017 (downloaded from Dropbox link shared by Mike Melnychuk at UWashington)
...
Explore RAM:  Preliminary RAM database v. 4.25.  Load from .RData file, including time series and metadata.  This initial chunk explores the variables included in the data.
