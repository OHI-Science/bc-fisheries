...
Explore RAM:  Preliminary RAM database v. 4.0.  Load from .RData file, including time series and metadata.  This initial chunk explores the variables included in the data.
