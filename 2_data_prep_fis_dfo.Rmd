...
```{r}
#albacore (not running this until we have 2013-2015 files)
...
```{r}
## STILL NEED TO ADD TUNA when we get 2013-2015

species_catch <- af %>%
  rbind(boc, dog, crab, cod, hal, herr, geo, ling, pop, hake, 
        rfish, sable, skates, prawn, pollock, soles, srsole, shrimp) %>%
